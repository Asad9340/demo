...
function Navbar() {
  return (
	...
	<div className="container flex justify-between h-16 mx-auto max-w-6xl">
    ...
    <li className="flex">
			...
			<li className="flex">
				<a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Store</a>
			</li>
			<li className="flex">
				<a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Offers</a>
			</li>
		</ul>
